...
. .\New-ExtractorConfiguration.ps1 -ApimInstanceName 'api-ops-prod-eastus' -ResourceGroupName 'RG-UmeshPagar' -Stage 'prod' -SubscriptionId 'df7ed44c-e98a-43c4-af18-241e33567262'
